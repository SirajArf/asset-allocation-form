    ...
    <div>
      ...
      <form>
        ...
        <div>
          ...
          <input type="email" className="m-3" placeholder="Enter your email" />
        </div>
      ...
      <div>
        <h3>Handovered By</h3>
        <hr />
        <label htmlFor="name" className="d-inline-flex p-2 bd-highlight">
          Name
        </label>
        <br />
        <input
          ...
          placeholder="Enter your first name"
        />
        <input type="text" className="m-3" placeholder="Enter your last name" />
      </div>
      <div>
        <label htmlFor="name">Email</label>
        <input
      ...
      <div>
        <h1>Acknowledgment and Declaration by the Employee</h1>
        <hr />
        <ol>
          <li>
